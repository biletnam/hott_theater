...
<html lang="<?php echo $template->language; ?>" dir="<?php echo $template->direction; ?>" >
	...
	<body id="avatar-template" class="<?php echo ($this->_responsive) ? 'avatar-responsive' : '';?>">
		...
		<div class="clearfix">
			...
			<?php if ($posTop): ?>
				<section id="avatar-header-block">
            ...
            <?php if ($template->countModules('full-1')): ?>
				<section id="avatar-full-1-block">
					<div class="avatar-wrapper <?php echo $template->params->get('avatar_full_1_block'); ?>">
                                            <div id="who_we_are"><jdoc:include type="modules" name="full-1" style="avatarmodule" /></div>
					</div>
				</section>
			<?php endif; ?>
            ...
            <?php if ($template->countModules('full-2')): ?>
				<section id="avatar-full-2-block">
					<div class="avatar-wrapper <?php echo $template->params->get('avatar_full_2_block'); ?>">
                                            <div id="what_we_do"><jdoc:include type="modules" name="full-2" style="avatarmodule" /></div>
					</div>
				</section>
			<?php endif; ?>
            ...
            <?php if ($template->countModules('full-3')): ?>
				<section id="avatar-full-3-block">
					<div class="avatar-wrapper <?php echo $template->params->get('avatar_full_3_block'); ?>">
                                            <div id="hott_kids"><jdoc:include type="modules" name="full-3" style="avatarmodule" /></div>
					</div>
				</section>
			<?php endif; ?>
            ...
            <?php if ($template->countModules('full-4')): ?>
				<section id="avatar-full-4-block">
					<div class="avatar-wrapper <?php echo $template->params->get('avatar_full_4_block'); ?>">
                                            <div id="whos_hott"><jdoc:include type="modules" name="full-4" style="avatarmodule" /></div>
					</div>
				</section>
			<?php endif; ?>			        

			<?php if ($posPromoTopLeft || $posPromoTopMiddle || $posPromoTopRight || $posUser10 || $posUser8 || $posUser9 || $posContentTop) :?>
				<section id="avatar-body-top-block">
			...
			<section id="avatar-body-middle-block" class="<?php echo ($hasLeftCol) ? 'has-left-col' :''; ?> <?php echo ($hasRightCol) ? 'has-right-col' :''; ?>">
            ...
            <?php if ($template->countModules('full-5')): ?>
				<section id="avatar-full-5-block">
					<div class="avatar-wrapper <?php echo $template->params->get('avatar_full_5_block'); ?>">
                                            <div id="casting_call"><jdoc:include type="modules" name="full-5" style="avatarmodule" /></div>
					</div>
				</section>
			<?php endif; ?>
			
            <?php if ($template->countModules('full-6') || $template->countModules('user-custom-1') || $template->countModules('user-custom-2')): ?>
				<section id="avatar-full-6-block">
					<div class="avatar-wrapper <?php echo $template->params->get('avatar_full_6_block'); ?>">
                                            <div id="hott_topics"><jdoc:include type="modules" name="full-6" style="avatarmodule" /></div>
                    	<div class="row-fluid">
							<?php if ($template->countModules('user-custom-1')): ?>
                                <div id="avatar-user-custom-1" class="span5">
                                    <jdoc:include type="modules" name="user-custom-1" style="avatarmodule" />
                                </div>
                            <?php endif; ?>
                            
                            <?php if ($template->countModules('user-custom-2')): ?>
                                <div id="avatar-user-custom-2" class="span7">
                                    <jdoc:include type="modules" name="user-custom-2" style="avatarmodule" />
                                </div>
                            <?php endif; ?>
                        </div>
					</div>
			...
			<?php if($posFooterLeft || $posFooterMiddle || $posFooterRight): ?>
				<section id="avatar-footer-inside-block">
			...
			<?php if ($posFooter): ?>
				<footer id="avatar-footer-block">
					<div class="avatar-wrapper <?php echo $template->params->get('avatar_footer_block'); ?>">
                                            <div id="contact_us"><jdoc:include type="modules" name="footer" style="avatarmodule" /></div>
					</div>
				</footer>
			<?php endif; ?>
