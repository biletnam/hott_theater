	...
	<form id="contact-form" action="<?php echo JRoute::_('index.php'); ?>" method="post" class="form-validate form-horizontal">
		<fieldset>
			...
			<?php if ($this->params->get('show_email_copy')) { ?>
				<div class="control-group send-copy">
					<div class="control-label">&nbsp;</div>
					<div class="controls"><?php echo $this->form->getLabel('contact_email_copy'); ?> <?php echo $this->form->getInput('contact_email_copy'); ?></div>
				</div>
			<?php } ?>
			...
			<?php foreach ($this->form->getFieldsets() as $fieldset) : ?>
				...
				<?php endif ?>
			<?php endforeach;?>
			<div class="content-right"><button class="btn btn-primary validate" type="submit"><?php echo JText::_('COM_CONTACT_CONTACT_SEND'); ?></button>
