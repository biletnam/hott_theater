...
<div id="k2Container" class="itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
  ...
  <?php echo $this->item->event->K2AfterDisplayTitle; ?>
    ...
    <div class="st-k2-article-toolbar">
  ...
  <?php if($this->item->params->get('itemCategory') || $this->item->params->get('itemTags') || $this->item->params->get('itemAttachments') || $this->item->params->get('itemHits')): ?>
  <div class="itemLinks">
	  
      <?php if($this->item->params->get('itemHits')): ?>
            <!-- Item Hits -->
          <div class="itemHits">
              <?php echo JText::_('K2_READ'); ?> <strong><?php echo $this->item->hits; ?></strong> <?php echo JText::_('K2_TIMES'); ?>
          </div>
      <?php endif; ?>
  ...
  <?php if($this->item->params->get('itemAuthorBlock') && empty($this->item->created_by_alias) || $this->item->params->get('itemAuthorLatest') && empty($this->item->created_by_alias) && isset($this->authorLatestItems)): ?>
  <!-- Author Block -->
	    ...
	    <li class="<?php echo ($key%2) ? "odd" : "even"; echo (!$this->item->created_by_alias && $comment->userID==$this->item->created_by) ? " authorResponse" : ""; echo($comment->published) ? '':' unpublishedComment'; ?>">
            ...
            <div class="itemCommentsWrapper">
            	<p class="commentAuthorName">
                    <i class="icon-user"></i> <?php echo JText::_('K2_POSTED_BY'); ?>
                ...
                <p class="commentDate">
                    <i class="icon-calendar"></i> <?php echo JHTML::_('date', $comment->commentDate, JText::_('K2_DATE_FORMAT_LC2')); ?>
                </p>                        
