...
// print email input
print '<div class="row-fluid"><label>' . $myEmailLabel  . '</label><input class="email inputbox ' . $mod_class_suffix . '" type="text" name="rp_email" size="' . $emailWidth . '" value="'.$CORRECT_EMAIL.'" placeholder="'.$myEmailLabel.'"/></div>' . "\n";
// print subject input
print '<div class="row-fluid"><label>' . $mySubjectLabel  . '</label><input class="subject inputbox ' . $mod_class_suffix . '" type="text" name="rp_subject" size="' . $subjectWidth . '" value="'.$CORRECT_SUBJECT.'" placeholder="'.$mySubjectLabel.'"/></div>' . "\n";
// print message input
